...
function CGame(oData){
    ...
    this._init = function(){
        ...
        scrtime = setInterval(function (){
          var ends=new Date().getTime();var counts=parseInt((ends-starts)/1000);
          var strhi='';
          var sss=endtimes-counts;//console.log(sss);
          if(endtimes<1) sss=0-sss;

          _oInterface.loseLife2(sss);
          if(endtimes-counts<1&&endtimes>0){
    ...
    this.assignScore = function(vPos,iType){
        ...
        _oInterface.refreshScore(_iScore);
        _icountnum++;
        _oInterface.losecountnum(_icountnum);
