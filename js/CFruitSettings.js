function CFruitSettings(){
	...
	s_aFruitSpriteSheet[4] = new createjs.SpriteSheet(oData); 4
        ...
        oData = {   // image to use
          framerate : 8,images: [oSprite],
          // width, height & registration point of each sprite
          frames: {width: 200, height: 200, regX: 100, regY: 100},
          animations: {   idle:[0],slice_1:[1],slice_2:[2],slice_3:[3],slice_4:[4],slice_5:[5],slice_6:[6],slice_7:[7],slice_8:[8]}
        };
        s_aFruitSpriteSheet[5] = new createjs.SpriteSheet(oData);
        s_aFruitSize[5] = {width:200,height:200,regX:100,regY:100};s_aFruitSpeed[5] = 18;s_aFruitColors[5] = "#6da818";
        s_aFruitScore[5] = 50;
        ...
        oSprite = s_oSpriteLibrary.getSprite('fruit_6');
        oData = {   // image to use
          framerate : 8,
          images: [oSprite],
          // width, height & registration point of each sprite
          frames: {width: 133, height: 128, regX: 66, regY: 64},
          animations: {   idle:[0],slice_1:[1],slice_2:[2],slice_3:[3],slice_4:[4],slice_5:[5],slice_6:[6],slice_7:[7],slice_8:[8]}
        };
        s_aFruitSpriteSheet[6] = new createjs.SpriteSheet(oData);
        s_aFruitSize[6] = {width: 133, height: 128, regX: 66, regY: 64};
        s_aFruitSpeed[6] = 24;
        s_aFruitColors[6] = "#74542d";
        s_aFruitScore[6] = 100;
        s_aFruitSpliceSound[6] = "fruit_slice_1";
    };
